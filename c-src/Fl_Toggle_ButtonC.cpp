...
void Fl_DerivedToggle_Button::destroy_data(){
  if (this->destroy != NULL){
    ...
    this->destroy((fl_Toggle_Button)this,res);
    if (fps) { free(fps); }
    free(res);
  }
}
EXPORT {
  ...
  FL_EXPORT_C(void*,Fl_Toggle_Button_user_data)(fl_Toggle_Button b){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_DerivedToggle_Button*>(b))->user_data()));
    if(stored_cb){
      return stored_cb->get_user_data();
    }
    else {
      return (static_cast<Fl_DerivedToggle_Button*>(b))->user_data();
    }
  }
  ...
  FL_EXPORT_C(void,Fl_Toggle_Button_draw_label_with_xywh_alignment)(fl_Toggle_Button b,int x,int y,int w,int h,Fl_Align alignment){
    (static_cast<Fl_DerivedToggle_Button*>(b))->draw_label(x,y,w,h,alignment);
  }
  FL_EXPORT_C(void,Fl_Toggle_Button_measure_label)(fl_Toggle_Button b,int* ww,int* hh){
    (static_cast<Fl_DerivedToggle_Button*>(b))->measure_label(*ww,*hh);
  }
  FL_EXPORT_C(fl_Window,    Fl_Toggle_Button_window)(fl_Toggle_Button toggle_button){
    return (fl_Window)(static_cast<Fl_DerivedToggle_Button*>(toggle_button))->window();
  }
  FL_EXPORT_C(fl_Window,    Fl_Toggle_Button_top_window)(fl_Toggle_Button toggle_button){
    return (fl_Window) (static_cast<Fl_DerivedToggle_Button*>(toggle_button))->top_window();
  }
  FL_EXPORT_C(fl_Window ,   Fl_Toggle_Button_top_window_offset)(fl_Toggle_Button toggle_button, int* xoff, int* yoff){
    return (fl_Window) (static_cast<Fl_DerivedToggle_Button*>(toggle_button))->top_window_offset(*xoff,*yoff);
  }
  FL_EXPORT_C(fl_Group,Fl_Toggle_Button_as_group)(fl_Toggle_Button toggle_button){
    return (fl_Group) (static_cast<Fl_DerivedToggle_Button*>(toggle_button))->as_group();
  }
  FL_EXPORT_C(fl_Gl_Window,Fl_Toggle_Button_as_gl_window)(fl_Toggle_Button toggle_button){
    return (fl_Gl_Window) (static_cast<Fl_DerivedToggle_Button*>(toggle_button))->as_gl_window();
  }
  FL_EXPORT_C(fl_Toggle_Button, Fl_Toggle_Button_New_WithLabel)(int x, int y, int w, int h, const char* label, Destroy_Function_Pointers dfps) {
    Fl_DerivedToggle_Button* button = new Fl_DerivedToggle_Button(x,y,w,h,label,dfps);
    return (static_cast<fl_Toggle_Button>(button));
  }
  FL_EXPORT_C(fl_Toggle_Button, Fl_Toggle_Button_New)(int x, int y, int w, int h, Destroy_Function_Pointers dfps) {
    Fl_DerivedToggle_Button* button = new Fl_DerivedToggle_Button(x,y,w,h,0,dfps);
    return (fl_Toggle_Button)button;
  }
  FL_EXPORT_C(void,Fl_Toggle_Button_Destroy)(fl_Toggle_Button button){
    delete (static_cast<Fl_DerivedToggle_Button*>(button));
  }
  FL_EXPORT_C(int,Fl_Toggle_Button_set_value)(fl_Toggle_Button b,int v){
    return (static_cast<Fl_DerivedToggle_Button*>(b))->value(v);
  }
  FL_EXPORT_C(char,Fl_Toggle_Button_value)(fl_Toggle_Button b){
    return (static_cast<Fl_DerivedToggle_Button*>(b))->value();
  }
  FL_EXPORT_C(int,Fl_Toggle_Button_clear)(fl_Toggle_Button b){
    return (static_cast<Fl_DerivedToggle_Button*>(b))->clear();
  }
  FL_EXPORT_C(void,Fl_Toggle_Button_setonly)(fl_Toggle_Button b){
    (static_cast<Fl_DerivedToggle_Button*>(b))->setonly();
  }
  FL_EXPORT_C(int,Fl_Toggle_Button_get_shortcut)(fl_Toggle_Button b){
    return (static_cast<Fl_DerivedToggle_Button*>(b))->shortcut();
  }
  FL_EXPORT_C(void,Fl_Toggle_Button_set_shortcut)(fl_Toggle_Button b,int s){
    (static_cast<Fl_DerivedToggle_Button*>(b))->shortcut(s);
  }
  FL_EXPORT_C(Fl_Boxtype,Fl_Toggle_Button_down_box)(fl_Toggle_Button b){
    return (static_cast<Fl_DerivedToggle_Button*>(b))->down_box();
  }
  FL_EXPORT_C(void,Fl_Toggle_Button_set_down_box)(fl_Toggle_Button b,Fl_Boxtype boxtype){
    (static_cast<Fl_DerivedToggle_Button*>(b))->down_box(boxtype);
  }
  FL_EXPORT_C(Fl_Color,Fl_Toggle_Button_down_color)(fl_Toggle_Button b){
    return (static_cast<Fl_DerivedToggle_Button*>(b))->down_color();
  }
  FL_EXPORT_C(void,Fl_Toggle_Button_set_down_color)(fl_Toggle_Button b,Fl_Color c){
    (static_cast<Fl_DerivedToggle_Button*>(b))->down_color(c);
  }
#ifdef __cplusplus
}
#endif
