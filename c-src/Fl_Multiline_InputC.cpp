...
EXPORT {
  ...
  FL_EXPORT_C(void*,Fl_Multiline_Input_user_data)(fl_Multiline_Input multiline_input){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->user_data()));
    if(stored_cb){
      return stored_cb->get_user_data();
    }
    else {
      return (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->user_data();
    }
  }
  ...
  FL_EXPORT_C(void,Fl_Multiline_Input_do_callback_with_widget_and_user_data)(fl_Multiline_Input multiline_input,fl_Widget w,long arg){
    (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->do_callback((static_cast<Fl_Widget*>(w)),arg);
  }
  ...
  FL_EXPORT_C(void,Fl_Multiline_Input_damage_inside_widget)(fl_Multiline_Input multiline_input,uchar c,int x,int y,int w,int h){
    (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->damage(c,x,y,w,h);
  }
  FL_EXPORT_C(void,Fl_Multiline_Input_draw_label_with_xywh_alignment)(fl_Multiline_Input multiline_input,int x,int y,int w,int h,Fl_Align alignment){
    (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->draw_label(x,y,w,h,alignment);
  }
  FL_EXPORT_C(void,Fl_Multiline_Input_measure_label)(fl_Multiline_Input multiline_input,int* ww,int* hh){
    (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->measure_label(*ww,*hh);
  }

  FL_EXPORT_C(fl_Window,    Fl_Multiline_Input_window)(fl_Multiline_Input multiline_input){
    return (fl_Window) (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->window();
  }
  FL_EXPORT_C(fl_Window,    Fl_Multiline_Input_top_window)(fl_Multiline_Input multiline_input){
    return (fl_Window) (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->top_window();
  }
  FL_EXPORT_C(fl_Window ,   Fl_Multiline_Input_top_window_offset)(fl_Multiline_Input multiline_input, int* xoff, int* yoff){
    return (fl_Window) (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->top_window_offset(*xoff,*yoff);
  }
  FL_EXPORT_C(fl_Group,Fl_Multiline_Input_as_group)(fl_Multiline_Input multiline_input){
    return (fl_Group) (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->as_group();
  }
  FL_EXPORT_C(fl_Gl_Window,Fl_Multiline_Input_as_gl_window)(fl_Multiline_Input multiline_input){
    return (fl_Gl_Window) (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->as_gl_window();
  }
  /* Fl_DerivedMultiline_Input specific functions */
  FL_EXPORT_C(fl_Multiline_Input, Fl_Multiline_Input_New_WithLabel)(int x, int y, int w, int h, const char* label,Destroy_Function_Pointers dfps) {
    Fl_DerivedMultiline_Input* multiline_input = new Fl_DerivedMultiline_Input(x,y,w,h,label,dfps);
    return (static_cast<fl_Multiline_Input>(multiline_input));
  }
  FL_EXPORT_C(fl_Multiline_Input, Fl_Multiline_Input_New)(int x, int y, int w, int h, Destroy_Function_Pointers dfps) {
    Fl_DerivedMultiline_Input* multiline_input = new Fl_DerivedMultiline_Input(x,y,w,h,0,dfps);
    return (static_cast<fl_Multiline_Input>(multiline_input));
  }
  FL_EXPORT_C(void,Fl_Multiline_Input_Destroy)(fl_Multiline_Input multiline_input){
    delete (static_cast<Fl_DerivedMultiline_Input*>(multiline_input));
  }
  FL_EXPORT_C(void,Fl_Multiline_Input_resize)(fl_Multiline_Input multiline_input,int X,int Y,int W,int H){
    (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->resize(X,Y,W,H);
  }
  FL_EXPORT_C(int,Fl_Multiline_Input_set_value)(fl_Multiline_Input multiline_input,const char* text){
    return (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->value(text);
  }
  FL_EXPORT_C(int,Fl_Multiline_Input_set_value_with_length)(fl_Multiline_Input multiline_input,const char* text,int length){
    return (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->value(text,length);
  }
  FL_EXPORT_C(int,Fl_Multiline_Input_static_value)(fl_Multiline_Input multiline_input,const char* text){
    return (static_cast<Fl_DerivedMultiline_Input*>(multiline_input))->static_value(text);
  }
