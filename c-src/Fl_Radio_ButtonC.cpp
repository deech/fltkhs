...
#ifdef __cplusplus
Fl_DerivedRadio_Button::Fl_DerivedRadio_Button(int x, int y, int w, int h, const char* label, Destroy_Function_Pointers destroy) : Fl_Radio_Button(x,y,w,h,label){
  destroy = destroy;
}
Fl_DerivedRadio_Button::~Fl_DerivedRadio_Button() {
  destroy_data();
}
void Fl_DerivedRadio_Button::destroy_data(){
  if (this->destroy != NULL){
    ...
    this->destroy((fl_Radio_Button)this,res);
    if (fps) { free(fps); }
    free(res);
  }
}
EXPORT {
  ...
  FL_EXPORT_C(void*,Fl_Radio_Button_user_data)(fl_Radio_Button b){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_DerivedRadio_Button*>(b))->user_data()));
    if(stored_cb){
      return stored_cb->get_user_data();
    }
    else {
      return (static_cast<Fl_DerivedRadio_Button*>(b))->user_data();
    }
  }
  ...
  FL_EXPORT_C(void,Fl_Radio_Button_draw_label_with_xywh_alignment)(fl_Radio_Button b,int x,int y,int w,int h,Fl_Align alignment){
    (static_cast<Fl_DerivedRadio_Button*>(b))->draw_label(x,y,w,h,alignment);
  }
  FL_EXPORT_C(void,Fl_Radio_Button_measure_label)(fl_Radio_Button b,int* ww,int* hh){
    (static_cast<Fl_DerivedRadio_Button*>(b))->measure_label(*ww,*hh);
  }
  FL_EXPORT_C(fl_Window,    Fl_Radio_Button_window)(fl_Radio_Button radio_button){
    return (fl_Window) (static_cast<Fl_DerivedRadio_Button*>(radio_button))->window();
  }
  FL_EXPORT_C(fl_Window,    Fl_Radio_Button_top_window)(fl_Radio_Button radio_button){
    return (fl_Window) (static_cast<Fl_DerivedRadio_Button*>(radio_button))->top_window();
  }
  FL_EXPORT_C(fl_Window ,   Fl_Radio_Button_top_window_offset)(fl_Radio_Button radio_button, int* xoff, int* yoff){
    return (fl_Window) (static_cast<Fl_DerivedRadio_Button*>(radio_button))->top_window_offset(*xoff,*yoff);
  }
  FL_EXPORT_C(fl_Group,Fl_Radio_Button_as_group)(fl_Radio_Button radio_button){
    return (fl_Group) (static_cast<Fl_DerivedRadio_Button*>(radio_button))->as_group();
  }
  FL_EXPORT_C(fl_Gl_Window,Fl_Radio_Button_as_gl_window)(fl_Radio_Button radio_button){
    return (fl_Gl_Window) (static_cast<Fl_DerivedRadio_Button*>(radio_button))->as_gl_window();
  }

  FL_EXPORT_C(fl_Radio_Button, Fl_Radio_Button_New_WithLabel)(int x, int y, int w, int h, const char* label, Destroy_Function_Pointers dfps) {
    Fl_DerivedRadio_Button* button = new Fl_DerivedRadio_Button(x,y,w,h,label,dfps);
    return (static_cast<fl_Radio_Button>(button));
  }
  FL_EXPORT_C(fl_Radio_Button, Fl_Radio_Button_New)(int x, int y, int w, int h, Destroy_Function_Pointers dfps) {
    Fl_DerivedRadio_Button* button = new Fl_DerivedRadio_Button(x,y,w,h,0,dfps);
    return (fl_Radio_Button)button;
  }
  FL_EXPORT_C(void,Fl_Radio_Button_Destroy)(fl_Radio_Button button){
    delete (static_cast<Fl_DerivedRadio_Button*>(button));
  }
  FL_EXPORT_C(int,Fl_Radio_Button_set_value)(fl_Radio_Button b,int v){
    return (static_cast<Fl_DerivedRadio_Button*>(b))->value(v);
  }
  FL_EXPORT_C(char,Fl_Radio_Button_value)(fl_Radio_Button b){
    return (static_cast<Fl_DerivedRadio_Button*>(b))->value();
  }
  FL_EXPORT_C(int,Fl_Radio_Button_clear)(fl_Radio_Button b){
    return (static_cast<Fl_DerivedRadio_Button*>(b))->clear();
  }
  FL_EXPORT_C(void,Fl_Radio_Button_setonly)(fl_Radio_Button b){
    (static_cast<Fl_DerivedRadio_Button*>(b))->setonly();
  }
  FL_EXPORT_C(int,Fl_Radio_Button_get_shortcut)(fl_Radio_Button b){
    return (static_cast<Fl_DerivedRadio_Button*>(b))->shortcut();
  }
  FL_EXPORT_C(void,Fl_Radio_Button_set_shortcut)(fl_Radio_Button b,int s){
    (static_cast<Fl_DerivedRadio_Button*>(b))->shortcut(s);
  }
  FL_EXPORT_C(Fl_Boxtype,Fl_Radio_Button_down_box)(fl_Radio_Button b){
    return (static_cast<Fl_DerivedRadio_Button*>(b))->down_box();
  }
  FL_EXPORT_C(void,Fl_Radio_Button_set_down_box)(fl_Radio_Button b,Fl_Boxtype boxtype){
    (static_cast<Fl_DerivedRadio_Button*>(b))->down_box(boxtype);
  }
  FL_EXPORT_C(Fl_Color,Fl_Radio_Button_down_color)(fl_Radio_Button b){
    return (static_cast<Fl_DerivedRadio_Button*>(b))->down_color();
  }
  FL_EXPORT_C(void,Fl_Radio_Button_set_down_color)(fl_Radio_Button b,Fl_Color c){
    (static_cast<Fl_DerivedRadio_Button*>(b))->down_color(c);
  }
#ifdef __cplusplus
}
#endif
