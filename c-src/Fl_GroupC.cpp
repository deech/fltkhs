...
EXPORT {
  ...
  FL_EXPORT_C(void*,Fl_Group_user_data)(fl_Group win){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_Group*>(win))->user_data()));
    if(stored_cb){
  ...
  FL_EXPORT_C(void,Fl_Group_set_user_data)(fl_Group win,void* v){
    ...
    if (stored_cb) {
      ...
      (static_cast<Fl_Group*>(win))->user_data(stored_cb);
    }
    else {
  ...
  FL_EXPORT_C(void,Fl_Group_set_visible_focus)(fl_Group win){
    (static_cast<Fl_Group*>(win))->set_visible_focus();
  }
