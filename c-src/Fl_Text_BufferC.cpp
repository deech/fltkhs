...
void Fl_DerivedText_Buffer::destroy_data(){
  if (this->destroy != NULL){
    int total_procs = this->mNPredeleteProcs + this->mNModifyProcs;
    fl_DoNotCall* fps = (fl_DoNotCall*) malloc(sizeof(fl_DoNotCall) * total_procs);
    int i;
    for (i = 0; i < this->mNPredeleteProcs; i++) {
      fps[i] = (fl_DoNotCall)this->mPredeleteProcs[i];
    }
    for (i = 0; i < this->mNModifyProcs; i++) {
      fps[i+this->mNPredeleteProcs] = (fl_DoNotCall)this->mModifyProcs[i];
    }
    Function_Pointers_To_Free* res = C_to_Fl_Callback::gather_function_pointers(1,total_procs,fps,(fl_DoNotCall)(this->transcoding_warning_action));
    this->destroy((fl_Text_Buffer)this,res);
    if (fps) { free(fps); }
    free(res);
  }
}
EXPORT {
  ...
  return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->input_file_was_transcoded;
}
  FL_EXPORT_C(const char*, Fl_Text_Buffer_file_encoding_warning_message)(fl_Text_Buffer text_buffer){
  return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->file_encoding_warning_message;
}
  ...
  FL_EXPORT_C(void,Fl_Text_Buffer_add_modify_callback)(fl_Text_Buffer text_buffer,Fl_Text_Modify_Cb bufModifiedCB,void* cbArg){
    (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->add_modify_callback(bufModifiedCB,cbArg);
  }
  FL_EXPORT_C(void,Fl_Text_Buffer_set_highlight)(fl_Text_Buffer text_buffer,int start,int end){
    (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->highlight(start,end);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_highlight)(fl_Text_Buffer text_buffer){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->highlight();
  }
  FL_EXPORT_C(void,Fl_Text_Buffer_unhighlight)(fl_Text_Buffer text_buffer){
    (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->unhighlight();
  }
  FL_EXPORT_C(char*,Fl_Text_Buffer_highlight_text)(fl_Text_Buffer text_buffer){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->highlight_text();
  }
  FL_EXPORT_C(void,Fl_Text_Buffer_remove_modify_callback)(fl_Text_Buffer text_buffer,Fl_Text_Modify_Cb bufModifiedCB,void* cbArg){
    (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->remove_modify_callback(bufModifiedCB,cbArg);
  }
  FL_EXPORT_C(void,Fl_Text_Buffer_call_modify_callbacks)(fl_Text_Buffer text_buffer){
    (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->call_modify_callbacks();
  }
  FL_EXPORT_C(void,Fl_Text_Buffer_add_predelete_callback)(fl_Text_Buffer text_buffer,Fl_Text_Predelete_Cb bufPredelCB,void* cbArg){
    (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->add_predelete_callback(bufPredelCB,cbArg);
  }
  ...
  FL_EXPORT_C(int,Fl_Text_Buffer_findchar_backward)(fl_Text_Buffer text_buffer,int startPos,unsigned int searchChar,int* foundPos){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->findchar_backward(startPos,searchChar,foundPos);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_search_forward)(fl_Text_Buffer text_buffer,int startPos,const char* searchString,int* foundPos){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->search_forward(startPos,searchString,foundPos);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_search_forward_with_matchcase)(fl_Text_Buffer text_buffer,int startPos,const char* searchString,int* foundPos,int matchCase){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->search_forward(startPos,searchString,foundPos,matchCase);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_search_backward)(fl_Text_Buffer text_buffer,int startPos,const char* searchString,int* foundPos){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->search_backward(startPos,searchString,foundPos);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_search_backward_with_matchcase)(fl_Text_Buffer text_buffer,int startPos,const char* searchString,int* foundPos,int matchCase){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->search_backward(startPos,searchString,foundPos,matchCase);
  }
  FL_EXPORT_C(fl_Text_Selection,Fl_Text_Buffer_primary_selection)(fl_Text_Buffer text_buffer){
    return (fl_Text_Selection)(static_cast<Fl_DerivedText_Buffer*>(text_buffer))->primary_selection();
  }
  FL_EXPORT_C(const fl_Text_Selection,Fl_Text_Buffer_secondary_selection)(fl_Text_Buffer text_buffer){
    return (fl_Text_Selection)(static_cast<Fl_DerivedText_Buffer*>(text_buffer))->secondary_selection();
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_next_char_clipped)(fl_Text_Buffer text_buffer,int ix){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->next_char_clipped(ix);
  }
  FL_EXPORT_C(const fl_Text_Selection,Fl_Text_Buffer_highlight_selection)(fl_Text_Buffer text_buffer){
    return (fl_Text_Selection)(static_cast<Fl_DerivedText_Buffer*>(text_buffer))->highlight_selection();
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_prev_char)(fl_Text_Buffer text_buffer,int ix){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->prev_char(ix);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_prev_char_clipped)(fl_Text_Buffer text_buffer,int ix){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->prev_char_clipped(ix);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_next_char)(fl_Text_Buffer text_buffer,int ix){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->next_char(ix);
  }
  FL_EXPORT_C(int,Fl_Text_Buffer_utf8_align)(fl_Text_Buffer text_buffer,int align){
    return (static_cast<Fl_DerivedText_Buffer*>(text_buffer))->utf8_align(align);
  }
  FL_EXPORT_C(fl_Text_Buffer, Fl_Text_Buffer_New)(Destroy_Function_Pointers dfps){
    Fl_DerivedText_Buffer* b = new Fl_DerivedText_Buffer(dfps);
    return (fl_Text_Buffer)b;
  }
  FL_EXPORT_C(fl_Text_Buffer, Fl_Text_Buffer_New_With_RequestedSize)(int requestedSize, Destroy_Function_Pointers dfps){
    Fl_DerivedText_Buffer* b = new Fl_DerivedText_Buffer(requestedSize,dfps);
    return (fl_Text_Buffer)b;
  }
  FL_EXPORT_C(fl_Text_Buffer, Fl_Text_Buffer_New_With_PreferredGapSize)(int preferredGapSize,Destroy_Function_Pointers dfps){
    Fl_DerivedText_Buffer* b = new Fl_DerivedText_Buffer(0,preferredGapSize,dfps);
    return (fl_Text_Buffer)b;
  }
  FL_EXPORT_C(fl_Text_Buffer, Fl_Text_Buffer_New_With_RequestedSize_PreferredGapSize)(int requestedSize, int preferredGapSize, Destroy_Function_Pointers dfps){
    Fl_DerivedText_Buffer* b = new Fl_DerivedText_Buffer(requestedSize,preferredGapSize,dfps);
    return (fl_Text_Buffer)b;
  }
  FL_EXPORT_C(void, Fl_Text_Buffer_Destroy)(fl_Text_Buffer text_buffer){
    delete(static_cast<Fl_DerivedText_Buffer*>(text_buffer));
  }
#ifdef __cplusplus
}
#endif
