...
EXPORT {
  ...
  FL_EXPORT_C(void*,Fl_Overlay_Window_user_data)(fl_Overlay_Window win){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_Overlay_Window*>(win))->user_data()));
    if(stored_cb){
      return stored_cb->get_user_data();
    }
    else {
      return (static_cast<Fl_Overlay_Window*>(win))->user_data();
    }
  }
  ...
  FL_EXPORT_C(void, Fl_Overlay_Window_default_callback)(fl_Overlay_Window win, void* v){
    Fl_Overlay_Window::default_callback((static_cast<Fl_Overlay_Window*>(win)), v);
  }
  FL_EXPORT_C(int, Fl_Overlay_Window_can_do_overlay)(fl_Overlay_Window win){
    return (static_cast<Fl_Overlay_Window*>(win))->can_do_overlay();
  }
  FL_EXPORT_C(void,Fl_Overlay_Window_redraw_overlay)(fl_Overlay_Window win){
    (static_cast<Fl_Overlay_Window*>(win))->redraw_overlay();
  }
#ifdef __cplusplus
}
#endif
