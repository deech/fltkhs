...
EXPORT {
  ...
  FL_EXPORT_C(void*,Fl_Select_Browser_user_data)(fl_Select_Browser select_browser){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_DerivedSelect_Browser*>(select_browser))->user_data()));
    if(stored_cb){
      return stored_cb->get_user_data();
    }
    else {
      return (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->user_data();
    }
  }
  ...
  FL_EXPORT_C(void,Fl_Select_Browser_draw_label_with_xywh_alignment)(fl_Select_Browser select_browser,int x,int y,int w,int h,Fl_Align alignment){
    (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->draw_label(x,y,w,h,alignment);
  }
  FL_EXPORT_C(void,Fl_Select_Browser_measure_label)(fl_Select_Browser select_browser,int* ww,int* hh){
    (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->measure_label(*ww,*hh);
  }
  FL_EXPORT_C(fl_Window,    Fl_Select_Browser_window)(fl_Select_Browser select_browser){
    return (fl_Window) (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->window();
  }
  FL_EXPORT_C(fl_Window,    Fl_Select_Browser_top_window)(fl_Select_Browser select_browser){
    return (fl_Window) (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->top_window();
  }
  FL_EXPORT_C(fl_Window ,   Fl_Select_Browser_top_window_offset)(fl_Select_Browser select_browser, int* xoff, int* yoff){
    return (fl_Window) (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->top_window_offset(*xoff,*yoff);
  }
  FL_EXPORT_C(fl_Group,Fl_Select_Browser_as_group_super)(fl_Select_Browser select_browser){
    return (fl_Group) (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->as_group();
  }
  ...
  FL_EXPORT_C(fl_Gl_Window,Fl_Select_Browser_as_gl_window_super)(fl_Select_Browser select_browser){
    return (fl_Gl_Window) (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->as_gl_window();
  }
  ...
  FL_EXPORT_C(void,Fl_Select_Browser_set_resizable_by_reference)(fl_Select_Browser select_browser,fl_Widget o){
    (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->resizable((static_cast<Fl_Widget*>(o)));
  }
  ...
  FL_EXPORT_C(fl_Select_Browser, Fl_Select_Browser_New_WithLabel)(int x, int y, int w, int h, const char* label,Destroy_Function_Pointers dfps) {
    Fl_DerivedSelect_Browser* select_browser = new Fl_DerivedSelect_Browser(x,y,w,h,label,dfps);
  ...
  FL_EXPORT_C(void,Fl_Select_Browser_hide_with_line)(fl_Select_Browser select_browser,int line){
    (static_cast<Fl_DerivedSelect_Browser*>(select_browser))->hide(line);
  }
