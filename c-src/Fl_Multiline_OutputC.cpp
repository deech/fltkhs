...
#ifdef __cplusplus
Fl_DerivedMultiline_Output::Fl_DerivedMultiline_Output(int x, int y, int w, int h, const char* label, Destroy_Function_Pointers destroy) : Fl_Multiline_Output(x,y,w,h,label){
  this->destroy = destroy;
}
Fl_DerivedMultiline_Output::~Fl_DerivedMultiline_Output() {
  destroy_data();
}
void Fl_DerivedMultiline_Output::destroy_data(){
  if (this->destroy != NULL){
    ...
    this->destroy((fl_Multiline_Output)this,res);
    if (fps) { free(fps); }
    free(res);
  }
}
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Multiline_Output_set_callback_with_user_data)(fl_Multiline_Output multiline_output,fl_Callback* cb,void* p){
    Fl_DerivedMultiline_Output* castedInput_dow = (static_cast<Fl_DerivedMultiline_Output*>(multiline_output));
  ...
  FL_EXPORT_C(void*,Fl_Multiline_Output_user_data)(fl_Multiline_Output multiline_output){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->user_data()));
    if(stored_cb){
      return stored_cb->get_user_data();
    }
    else {
      return (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->user_data();
    }
  }
  ...
  FL_EXPORT_C(void,Fl_Multiline_Output_do_callback_with_widget_and_user_data)(fl_Multiline_Output multiline_output,fl_Widget w,long arg){
    (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->do_callback((static_cast<Fl_Widget*>(w)),arg);
  }
  ...
  FL_EXPORT_C(void,Fl_Multiline_Output_damage_inside_widget)(fl_Multiline_Output multiline_output,uchar c,int x,int y,int w,int h){
    (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->damage(c,x,y,w,h);
  }
  FL_EXPORT_C(void,Fl_Multiline_Output_draw_label_with_xywh_alignment)(fl_Multiline_Output multiline_output,int x,int y,int w,int h,Fl_Align alignment){
    (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->draw_label(x,y,w,h,alignment);
  }
  FL_EXPORT_C(void,Fl_Multiline_Output_measure_label)(fl_Multiline_Output multiline_output,int* ww,int* hh){
    (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->measure_label(*ww,*hh);
  }

  FL_EXPORT_C(fl_Window,    Fl_Multiline_Output_window)(fl_Multiline_Output multiline_output){
    return (fl_Window) (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->window();
  }
  FL_EXPORT_C(fl_Window,    Fl_Multiline_Output_top_window)(fl_Multiline_Output multiline_output){
    return (fl_Window) (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->top_window();
  }
  FL_EXPORT_C(fl_Window ,   Fl_Multiline_Output_top_window_offset)(fl_Multiline_Output multiline_output, int* xoff, int* yoff){
    return (fl_Window) (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->top_window_offset(*xoff,*yoff);
  }
  FL_EXPORT_C(fl_Group,Fl_Multiline_Output_as_group)(fl_Multiline_Output multiline_output){
    return (fl_Group) (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->as_group();
  }
  FL_EXPORT_C(fl_Gl_Window,Fl_Multiline_Output_as_gl_window)(fl_Multiline_Output multiline_output){
    return (fl_Gl_Window) (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->as_gl_window();
  }
  /* Fl_DerivedMultiline_Output specific functions */
  FL_EXPORT_C(fl_Multiline_Output, Fl_Multiline_Output_New_WithLabel)(int x, int y, int w, int h, const char* label, Destroy_Function_Pointers dfps) {
    Fl_DerivedMultiline_Output* multiline_output = new Fl_DerivedMultiline_Output(x,y,w,h,label,dfps);
  ...
  FL_EXPORT_C(fl_Multiline_Output, Fl_Multiline_Output_New)(int x, int y, int w, int h, Destroy_Function_Pointers dfps) {
    Fl_DerivedMultiline_Output* multiline_output = new Fl_DerivedMultiline_Output(x,y,w,h,0,dfps);
  ...
  FL_EXPORT_C(void,Fl_Multiline_Output_Destroy)(fl_Multiline_Output multiline_output){
    delete (static_cast<Fl_DerivedMultiline_Output*>(multiline_output));
  }
  FL_EXPORT_C(void,Fl_Multiline_Output_resize)(fl_Multiline_Output multiline_output,int X,int Y,int W,int H){
    (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->resize(X,Y,W,H);
  }
  FL_EXPORT_C(int,Fl_Multiline_Output_set_value)(fl_Multiline_Output multiline_output,const char* text){
    return (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->value(text);
  }
  FL_EXPORT_C(int,Fl_Multiline_Output_set_value_with_length)(fl_Multiline_Output multiline_output,const char* text,int length){
    return (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->value(text,length);
  }
  FL_EXPORT_C(int,Fl_Multiline_Output_static_value)(fl_Multiline_Output multiline_output,const char* text){
    return (static_cast<Fl_DerivedMultiline_Output*>(multiline_output))->static_value(text);
  }
