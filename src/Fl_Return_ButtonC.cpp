...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Return_Button_set_background_and_selection_color)(fl_Return_Button b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Return_Button_draw_label)(fl_Return_Button b,int x,int y,int w,int h,Fl_Align alignment){
