...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Check_Button_set_background_and_selection_color)(fl_Check_Button b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Check_Button_set_callback_and_user_data)(fl_Check_Button b,fl_Callback* cb,void* p){
  ...
  FL_EXPORT_C(void,Fl_Check_Button_set_visible_focus)(fl_Check_Button b){
    (static_cast<Fl_Check_Button*>(b))->visible_focus();
  }
  ...
  FL_EXPORT_C(void,Fl_Check_Button_draw_label)(fl_Check_Button b,int x,int y,int w,int h,Fl_Align alignment){
  ...
  FL_EXPORT_C(Fl_Boxtype,Fl_Check_Button_get_down_box)(fl_Check_Button b){
  ...
  FL_EXPORT_C(Fl_Color,Fl_Check_Button_get_down_color)(fl_Check_Button b){
