...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Value_Slider_set_background_and_selection_color)(fl_Value_Slider value_slider,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Value_Slider_draw_label)(fl_Value_Slider value_slider,int x,int y,int w,int h,Fl_Align alignment){
