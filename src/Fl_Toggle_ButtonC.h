...
EXPORT {
  ...
  FL_EXPORT_C(void,         Fl_Toggle_Button_set_background_and_selection_color)(fl_Toggle_Button win,Fl_Color bg, Fl_Color a);
  ...
  FL_EXPORT_C(void,         Fl_Toggle_Button_draw_label)(fl_Toggle_Button win, int x , int y , int w, int h, Fl_Align alignment);
