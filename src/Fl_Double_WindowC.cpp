...
EXPORT {
  ...
  FL_EXPORT_C(fl_Group,Fl_Double_Window_parent)(fl_Double_Window win){
    return (fl_Group) (static_cast<Fl_Double_Window*>(win))->parent();
  }
  ...
  FL_EXPORT_C(void*,Fl_Double_Window_user_data)(fl_Double_Window win){
    C_to_Fl_Callback* stored_cb = (static_cast<C_to_Fl_Callback*>((static_cast<Fl_Double_Window*>(win))->user_data()));
    if(stored_cb){
  ...
  FL_EXPORT_C(void,Fl_Double_Window_set_user_data)(fl_Double_Window win,void* v){
    ...
    if (stored_cb) {
      ...
      (static_cast<Fl_Double_Window*>(win))->user_data(stored_cb);
    }
    else {
