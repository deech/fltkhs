...
EXPORT {
  ...
  FL_EXPORT_C(fl_Group,Fl_Input_parent)(fl_Input input){
    return (static_cast<Fl_Input*>(input))->parent();
  }
  ...
  FL_EXPORT_C(void,Fl_Input_set_background_and_selection_color)(fl_Input input,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Input_set_callback_and_user_data)(fl_Input input,fl_Callback* cb,void* p){
  ...
  FL_EXPORT_C(void,Fl_Input_set_visible_focus)(fl_Input input){
    (static_cast<Fl_Input*>(input))->visible_focus();
  }
  ...
  FL_EXPORT_C(int,Fl_Input_handle)(fl_Input input,int event){
    return (static_cast<Fl_Input*>(input))->handle(event);
  }
