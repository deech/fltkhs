...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Float_Input_set_background_and_selection_color)(fl_Float_Input float_input,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Float_Input_set_visible_focus)(fl_Float_Input float_input){
    (static_cast<Fl_Float_Input*>(float_input))->visible_focus();
  }
  ...
  FL_EXPORT_C(int,Fl_Float_Input_handle)(fl_Float_Input float_input,int event){
    return (static_cast<Fl_Float_Input*>(float_input))->handle(event);
  }
