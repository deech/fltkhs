...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Repeat_Button_set_background_and_selection_color)(fl_Repeat_Button b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Repeat_Button_set_visible_focus)(fl_Repeat_Button b){
    (static_cast<Fl_Repeat_Button*>(b))->visible_focus();
  }
