...
#ifdef __cplusplus
Fl_DerivedTableRow::Fl_DerivedTableRow(int X, int Y, int W, int H, const char *l, fl_Table_Virtual_Funcs* funcs) : Fl_Table_Row(X,Y,W,H,l){
    overriddenFuncs = funcs;
    other_data = (void*)"INIT";
 }
Fl_DerivedTableRow::Fl_DerivedTableRow(int X, int Y, int W, int H, fl_Table_Virtual_Funcs* funcs):Fl_Table_Row(X,Y,W,H,0){
    overriddenFuncs = funcs;
    other_data = (void*)"INIT";
  }
...
int Fl_DerivedTableRow::handle(int event){
  int i;
...
void Fl_DerivedTableRow::resize_super(int x, int y, int w, int h){
  Fl_Table_Row::resize(x,y,w,h);
}
void Fl_DerivedTableRow::resize(int x, int y, int w, int h){
...
Fl_Group* Fl_DerivedTableRow::as_group(){
  Fl_Group* grp;
...
Fl_Window* Fl_DerivedTableRow::as_window(){
  Fl_Window* win;
...
Fl_Gl_Window* Fl_DerivedTableRow::as_gl_window(){
  Fl_Gl_Window* win;
...
void Fl_DerivedTableRow::draw_cell(TableContext tableContext, int R, int C, int X, int Y, int W, int H){
...
EXPORT {
  ...
  FL_EXPORT_C(int,Fl_Table_Row_x)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->x();
  }
  FL_EXPORT_C(int,Fl_Table_Row_y)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->y();
  }
  FL_EXPORT_C(int,Fl_Table_Row_w)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->w();
  }
  FL_EXPORT_C(int,Fl_Table_Row_h)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->h();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_align)(fl_Table_Row table_row, Fl_Align alignment){
    (static_cast<Fl_DerivedTableRow*>(table_row))->align(alignment);
  }
  FL_EXPORT_C(Fl_Align,Fl_Table_Row_align)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->align();
  }
  FL_EXPORT_C(Fl_Boxtype,Fl_Table_Row_box)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->box();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_box)(fl_Table_Row table_row,Fl_Boxtype new_box){
    (static_cast<Fl_DerivedTableRow*>(table_row))->box((static_cast<Fl_Boxtype>(new_box)));
  }
  FL_EXPORT_C(Fl_Color,Fl_Table_Row_color)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->color();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_color)(fl_Table_Row table_row,Fl_Color bg){
    (static_cast<Fl_DerivedTableRow*>(table_row))->color(bg);
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_background_and_selection_color)(fl_Table_Row table_row,Fl_Color bg,Fl_Color a){
    (static_cast<Fl_DerivedTableRow*>(table_row))->color(bg,a);
  }
  FL_EXPORT_C(Fl_Color,Fl_Table_Row_selection_color)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->selection_color();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_selection_color)(fl_Table_Row table_row,Fl_Color a){
    (static_cast<Fl_DerivedTableRow*>(table_row))->selection_color(a);
  }
  FL_EXPORT_C(const char*,Fl_Table_Row_label)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->label();
  }
  FL_EXPORT_C(void,Fl_Table_Row_copy_label)(fl_Table_Row table_row,const char* new_label){
    (static_cast<Fl_DerivedTableRow*>(table_row))->copy_label(new_label);
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_label)(fl_Table_Row table_row,const char* text){
    (static_cast<Fl_DerivedTableRow*>(table_row))->label(text);
  }
  FL_EXPORT_C(Fl_Labeltype,Fl_Table_Row_labeltype)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->labeltype();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_labeltype)(fl_Table_Row table_row,Fl_Labeltype a){
    (static_cast<Fl_DerivedTableRow*>(table_row))->labeltype(a);
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_labelcolor)(fl_Table_Row table_row,Fl_Color c){
    (static_cast<Fl_DerivedTableRow*>(table_row))->labelcolor(c);
  }
  FL_EXPORT_C(Fl_Font,Fl_Table_Row_labelfont)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->labelfont();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_labelfont)(fl_Table_Row table_row,Fl_Font c){
    (static_cast<Fl_DerivedTableRow*>(table_row))->labelfont((static_cast<Fl_Font>(c)));
  }
  FL_EXPORT_C(Fl_Fontsize,Fl_Table_Row_labelsize)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->labelsize();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_labelsize)(fl_Table_Row table_row,Fl_Fontsize pix){
    (static_cast<Fl_DerivedTableRow*>(table_row))->labelsize((static_cast<Fl_Fontsize>(pix)));
  }
  FL_EXPORT_C(fl_Image,Fl_Table_Row_image)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->image();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_image)(fl_Table_Row table_row,fl_Image pix){
    (static_cast<Fl_DerivedTableRow*>(table_row))->image((static_cast<Fl_Image*>(pix)));
  }
  FL_EXPORT_C(fl_Image,Fl_Table_Row_deimage)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->deimage();
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_deimage)(fl_Table_Row table_row,fl_Image pix){
    (static_cast<Fl_DerivedTableRow*>(table_row))->deimage((static_cast<Fl_Image*>(pix)));
  }
  FL_EXPORT_C(const char*,Fl_Table_Row_tooltip)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->tooltip();
  }
  FL_EXPORT_C(void,Fl_Table_Row_copy_tooltip)(fl_Table_Row table_row,const char* text){
    (static_cast<Fl_DerivedTableRow*>(table_row))->copy_tooltip(text);
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_tooltip)(fl_Table_Row table_row,const char* text){
    (static_cast<Fl_DerivedTableRow*>(table_row))->tooltip(text);
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_callback_and_user_data)(fl_Table_Row table_row,fl_Callback* cb,void* p){
    Fl_DerivedTableRow* castedWindow = (static_cast<Fl_DerivedTableRow*>(table_row));
  ...
  FL_EXPORT_C(void,Fl_Table_Row_show)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->show();
  }
  ...
  FL_EXPORT_C(fl_Widget,Fl_Table_Row_resizable)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->resizable();
  }
  FL_EXPORT_C(void,Fl_Table_Row_add_resizable)(fl_Table_Row table_row,fl_Widget o){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->add_resizable(*(static_cast<Fl_Widget*>(o)));
  }
  FL_EXPORT_C(void,Fl_Table_Row_set_clip_children)(fl_Table_Row table_row,int c){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->clip_children(c);
  }
  FL_EXPORT_C(unsigned int,Fl_Table_Row_clip_children)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->clip_children();
  }
  FL_EXPORT_C(void,Fl_Table_Row_focus)(fl_Table_Row table_row, fl_Widget W){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->focus((static_cast<Fl_Widget*>(W)));
  }
  ...
  FL_EXPORT_C(Fl_Boxtype,Fl_Table_Row_table_box)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->table_box();
  }
  FL_EXPORT_C(int,Fl_Table_Row_rows)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->rows();
  }
  FL_EXPORT_C(int,Fl_Table_Row_cols)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->cols();
  }
  ...
  FL_EXPORT_C(void,Fl_Table_Row_set_rows)(fl_Table_Row table_row, int val){
    (static_cast<Fl_DerivedTableRow*>(table_row))->rows(val);
  }
  ...
  FL_EXPORT_C(void,Fl_Table_Row_clear)(fl_Table_Row table_row){
    (static_cast<Fl_DerivedTableRow*>(table_row))->clear();
  }
  FL_EXPORT_C(void,Fl_Table_Row_begin)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->begin();
  }
  ...
  FL_EXPORT_C(int,Fl_Table_Row_find)(fl_Table_Row table_row,fl_Widget wgt){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->find((static_cast<Fl_Widget*>(wgt)));
  }
  FL_EXPORT_C(int,Fl_Table_Row_callback_row)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->callback_row();
  }
  FL_EXPORT_C(int,Fl_Table_Row_callback_col)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->callback_col();
  }
  FL_EXPORT_C(TableContextC,Fl_Table_Row_callback_context)(fl_Table_Row table_row){
    Fl_DerivedTableRow* t = (static_cast<Fl_DerivedTableRow*>(table_row));
  ...
  FL_EXPORT_C(void,Fl_Table_Row_do_callback)(fl_Table_Row table_row, TableContextC tableContext, int row, int col){
    ...
    (static_cast<Fl_DerivedTableRow*>(table_row))->do_callback(c, row, col);
  }
#if FLTK_ABI_VERSION >= 10302
  FL_EXPORT_C(void, Fl_Table_Row_set_tab_cell_nav)(fl_Table_Row table_row, int val){
    (static_cast<Fl_DerivedTableRow*>(table_row))->tab_cell_nav(val);
  }
  FL_EXPORT_C(int,  Fl_Table_Row_tab_cell_nav)(fl_Table_Row table_row){
    return (static_cast<Fl_DerivedTableRow*>(table_row))->tab_cell_nav();
  }
  FL_EXPORT_C(int,  Fl_Table_Row_find_cell)(fl_Table_Row table_row, TableContextC context, int R, int C, int *X, int *Y, int *W, int *H){
    ...
    return (static_cast<Fl_DerivedTableRow*>(table_row))->find_cell(c,R,C,*X,*Y,*W,*H);
  }
  FL_EXPORT_C(fl_Table_Row, Fl_Table_Row_New_WithLabel)(int X, int Y, int W, int H, const char *l){
    ...
    Fl_DerivedTableRow* table = new Fl_DerivedTableRow(X,Y,W,H,l,funcs);
    return (fl_Table_Row)table;
  }
  FL_EXPORT_C(fl_Table_Row, Fl_Table_Row_New)(int X, int Y, int W, int H){
    fl_Table_Row_Virtual_Funcs* funcs = Fl_Table_Row_default_virtual_funcs();
    Fl_DerivedTableRow* table = new Fl_DerivedTableRow(X,Y,W,H,funcs);
    return (fl_Table_Row)table;
  }
  ...
  FL_EXPORT_C(void, Fl_Table_Row_Destroy)(fl_Table_Row table_row){
    delete (static_cast<Fl_DerivedTableRow*>(table_row));
  }
  FL_EXPORT_C(TableRowSelectModeC,Fl_Table_Row_type)(fl_Table_Row table){
    Fl_Table_Row::TableRowSelectMode m = (static_cast<Fl_DerivedTableRow*>(table))->type();
