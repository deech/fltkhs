...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Clock_set_background_and_selection_color)(fl_Clock b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Clock_draw_label)(fl_Clock b,int x,int y,int w,int h,Fl_Align alignment){
