...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Toggle_Button_set_background_and_selection_color)(fl_Toggle_Button b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Toggle_Button_set_callback_and_user_data)(fl_Toggle_Button b,fl_Callback* cb,void* p){
  ...
  FL_EXPORT_C(void,Fl_Toggle_Button_draw_label)(fl_Toggle_Button b,int x,int y,int w,int h,Fl_Align alignment){
  ...
  FL_EXPORT_C(Fl_Boxtype,Fl_Toggle_Button_get_down_box)(fl_Toggle_Button b){
  ...
  FL_EXPORT_C(Fl_Color,Fl_Toggle_Button_get_down_color)(fl_Toggle_Button b){
