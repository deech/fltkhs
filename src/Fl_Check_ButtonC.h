...
EXPORT {
  ...
  FL_EXPORT_C(void,         Fl_Check_Button_set_background_and_selection_color)(fl_Check_Button win,Fl_Color bg, Fl_Color a);
  ...
  FL_EXPORT_C(void,         Fl_Check_Button_set_callback_and_user_data)(fl_Check_Button win, fl_Callback* cb, void* p);
