...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Text_Editor_highlight_data)(fl_Text_Editor text_editor,fl_Text_Buffer styleBuffer,Style_Table_Entry *styleTable,int nStyles,char unfinishedStyle,Unfinished_Style_Cb unfinishedHighlightCB,void *cbArg){
    ...
    (static_cast<Fl_Text_Editor*>(text_editor))->highlight_data((static_cast<Fl_Text_Buffer*>(styleBuffer)),s,nStyles,unfinishedStyle,unfinishedHighlightCB,cbArg);
  }
  FL_EXPORT_C(int,Fl_Text_Editor_position_style)(fl_Text_Editor text_editor,int lineStartPos,int lineLen,int lineIndex){
    return (static_cast<Fl_Text_Editor*>(text_editor))->position_style(lineStartPos,lineLen,lineIndex);
  }
  FL_EXPORT_C(int,Fl_Text_Editor_shortcut)(fl_Text_Editor text_editor){
    return (static_cast<Fl_Text_Editor*>(text_editor))->shortcut();
  }
  FL_EXPORT_C(void,Fl_Text_Editor_set_shortcut)(fl_Text_Editor text_editor,int s){
    return (static_cast<Fl_Text_Editor*>(text_editor))->shortcut(s);
  }
  FL_EXPORT_C(Fl_Font,Fl_Text_Editor_textfont)(fl_Text_Editor text_editor){
    return (static_cast<Fl_Text_Editor*>(text_editor))->textfont();
  }
  FL_EXPORT_C(void,Fl_Text_Editor_set_textfont)(fl_Text_Editor text_editor,Fl_Font s){
    return (static_cast<Fl_Text_Editor*>(text_editor))->textfont(s);
  }
  FL_EXPORT_C(Fl_Fontsize,Fl_Text_Editor_textsize)(fl_Text_Editor text_editor){
    return (static_cast<Fl_Text_Editor*>(text_editor))->textsize();
  }
  FL_EXPORT_C(void,Fl_Text_Editor_set_textsize)(fl_Text_Editor text_editor,Fl_Fontsize s){
    return (static_cast<Fl_Text_Editor*>(text_editor))->textsize(s);
  }
  FL_EXPORT_C(Fl_Color,Fl_Text_Editor_textcolor)(fl_Text_Editor text_editor){
    return (static_cast<Fl_Text_Editor*>(text_editor))->textcolor();
  }
  FL_EXPORT_C(void,Fl_Text_Editor_set_textcolor)(fl_Text_Editor text_editor,Fl_Color n){
    return (static_cast<Fl_Text_Editor*>(text_editor))->textcolor(n);
  }
  FL_EXPORT_C(int,Fl_Text_Editor_wrapped_column)(fl_Text_Editor text_editor,int row,int column){
    return (static_cast<Fl_Text_Editor*>(text_editor))->wrapped_column(row,column);
  }
  FL_EXPORT_C(int,Fl_Text_Editor_wrapped_row)(fl_Text_Editor text_editor,int row){
    return (static_cast<Fl_Text_Editor*>(text_editor))->wrapped_row(row);
  }
  FL_EXPORT_C(void,Fl_Text_Editor_wrap_mode)(fl_Text_Editor text_editor,int wrap,int wrap_margin){
    return (static_cast<Fl_Text_Editor*>(text_editor))->wrap_mode(wrap,wrap_margin);
  }
  FL_EXPORT_C(double,Fl_Text_Editor_x_to_col)(fl_Text_Editor text_editor,double x){
    return (static_cast<Fl_Text_Editor*>(text_editor))->x_to_col(x);
  }
  FL_EXPORT_C(double,Fl_Text_Editor_col_to_x)(fl_Text_Editor text_editor,double col){
    return (static_cast<Fl_Text_Editor*>(text_editor))->col_to_x(col);
  }
 FL_EXPORT_C(void,Fl_Text_Editor_set_insert_mode)(fl_Text_Editor text_editor,int b){
   (static_cast<Fl_Text_Editor*>(text_editor))->insert_mode(b);
 }
 FL_EXPORT_C(int,Fl_Text_Editor_insert_mode)(fl_Text_Editor text_editor){
   return (static_cast<Fl_Text_Editor*>(text_editor))->insert_mode();
 }
 FL_EXPORT_C(void,Fl_Text_Editor_add_key_binding)(fl_Text_Editor text_editor,int key,int state,fl_Key_Func f,Key_BindingC** list){
   (static_cast<Fl_Text_Editor*>(text_editor))->add_key_binding(key,state,f,list);
 }
 FL_EXPORT_C(void,Fl_Text_Editor_add_key_binding_with_list)(fl_Text_Editor text_editor,int key,int state,fl_Key_Func f){
   (static_cast<Fl_Text_Editor*>(text_editor))->add_key_binding(key,state,f);
 }
 FL_EXPORT_C(void,Fl_Text_Editor_remove_key_binding_with_list)(fl_Text_Editor text_editor,int key,int state,Key_BindingC** list){
   (static_cast<Fl_Text_Editor*>(text_editor))->remove_key_binding(key,state,list);
 }
 FL_EXPORT_C(void,Fl_Text_Editor_remove_key_binding)(fl_Text_Editor text_editor,int key,int state){
   (static_cast<Fl_Text_Editor*>(text_editor))->remove_key_binding(key,state);
 }
 FL_EXPORT_C(void,Fl_Text_Editor_remove_all_key_bindings_with_list)(fl_Text_Editor text_editor,Key_BindingC** list){
   (static_cast<Fl_Text_Editor*>(text_editor))->remove_all_key_bindings(list);
 }
 FL_EXPORT_C(void,Fl_Text_Editor_remove_all_key_bindings)(fl_Text_Editor text_editor){
   (static_cast<Fl_Text_Editor*>(text_editor))->remove_all_key_bindings();
 }
 FL_EXPORT_C(void,Fl_Text_Editor_add_default_key_bindings)(fl_Text_Editor text_editor,Key_BindingC** list){
   (static_cast<Fl_Text_Editor*>(text_editor))->add_default_key_bindings(list);
 }
 FL_EXPORT_C(fl_Key_Func,Fl_Text_Editor_bound_key_function_with_list)(fl_Text_Editor text_editor,int key,int state,Key_BindingC* list){
   return (static_cast<Fl_Text_Editor*>(text_editor))->bound_key_function(key,state,list);
 }
 FL_EXPORT_C(fl_Key_Func,Fl_Text_Editor_bound_key_function)(fl_Text_Editor text_editor,int key,int state){
   return (static_cast<Fl_Text_Editor*>(text_editor))->bound_key_function(key,state);
 }
 FL_EXPORT_C(void,Fl_Text_Editor_default_key_function)(fl_Text_Editor text_editor,fl_Key_Func f){
   (static_cast<Fl_Text_Editor*>(text_editor))->default_key_function(f);
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_undo)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_undo(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_ignore)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_ignore(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_backspace)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_backspace(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_enter)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_enter(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_move)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_move(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_shift_move)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_shift_move(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_ctrl_move)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_ctrl_move(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_c_s_move)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_c_s_move(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_meta_move)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_meta_move(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_m_s_move)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_m_s_move(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_home)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_home(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_end)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_end(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_left)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_left(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_up)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_up(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_right)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_right(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_down)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_down(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_page_up)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_page_up(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_page_down)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_page_down(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_insert)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_insert(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_delete)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_delete(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_copy)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_copy(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_cut)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_cut(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_paste)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_paste(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_select_all)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_select_all(c,(static_cast<Fl_Text_Editor*>(e)));
 }
 FL_EXPORT_C(int,Fl_Text_Editor_kf_default)(int c,fl_Text_Editor e){
   return Fl_Text_Editor::kf_default(c,(static_cast<Fl_Text_Editor*>(e)));
 }
#ifdef __cplusplus
}
#endif
