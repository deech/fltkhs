...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Round_Button_set_background_and_selection_color)(fl_Round_Button b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Round_Button_set_visible_focus)(fl_Round_Button b){
    (static_cast<Fl_Round_Button*>(b))->visible_focus();
  }
  ...
  FL_EXPORT_C(void,Fl_Round_Button_draw_label)(fl_Round_Button b,int x,int y,int w,int h,Fl_Align alignment){
  ...
  FL_EXPORT_C(Fl_Boxtype,Fl_Round_Button_get_down_box)(fl_Round_Button b){
  ...
  FL_EXPORT_C(Fl_Color,Fl_Round_Button_get_down_color)(fl_Round_Button b){
