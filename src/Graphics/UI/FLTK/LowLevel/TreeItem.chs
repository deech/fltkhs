...
{# fun Fl_Tree_Item_New_WithPrefs as newTreeItem' {id `Ptr ()'} -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_show_self_with_indent as showSelfWithIndent' { id `Ptr ()',`CString' } -> `()' #}
...
{# fun Fl_Tree_Item_label as label' { id `Ptr ()' } -> `CString' #}
...
{# fun Fl_Tree_Item_labelfont as labelfont' { id `Ptr ()' } -> `Font' cToFont #}
...
{# fun Fl_Tree_Item_set_labelsize as setLabelsize' { id `Ptr ()', id `CInt' } -> `()' #}
...
{# fun Fl_Tree_Item_labelsize as labelsize' { id `Ptr ()' } -> `CInt' id #}
...
{# fun Fl_Tree_Item_set_labelcolor as setLabelcolor' { id `Ptr ()',cFromColor `Color' } -> `()' #}
...
{# fun Fl_Tree_Item_labelcolor as labelcolor' { id `Ptr ()' } -> `Color' cToColor #}
...
{# fun Fl_Tree_Item_labelfgcolor as labelfgcolor' { id `Ptr ()' } -> `Color' cToColor #}
...
{# fun Fl_Tree_Item_set_labelfgcolor as setLabelfgcolor' { id `Ptr ()',cFromColor `Color' } -> `()' #}
...
{# fun Fl_Tree_Item_set_labelbgcolor as setLabelbgcolor' { id `Ptr ()',cFromColor `Color' } -> `()' #}
...
{# fun Fl_Tree_Item_labelbgcolor as labelbgcolor' { id `Ptr ()' } -> `Color' cToColor #}
...
{# fun Fl_Tree_Item_find_child as findChild' { id `Ptr ()',`CString' } -> `Int' #}
...
{# fun Fl_Tree_Item_remove_child as removeChild' { id `Ptr ()',`CString' } -> `Int' #}
...
{# fun Fl_Tree_Item_clear_children as clearChildren' { id `Ptr ()' } -> `()' #}
...
{# fun Fl_Tree_Item_add as add' {id `Ptr ()', id `Ptr ()', `CString'} -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_insert as insert' { id `Ptr ()',id `Ptr ()',`CString' } -> `Ptr ()' id #}
{# fun Fl_Tree_Item_insert_with_pos as insertWithPos' { id `Ptr ()',id `Ptr ()',`CString',`Int' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_insert_above as insertAbove' { id `Ptr ()',id `Ptr ()', `CString' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_move_above as move_above' { id `Ptr ()', id `Ptr ()'} -> `Int' #}
{# fun Fl_Tree_Item_move_below as move_below' { id `Ptr ()', id `Ptr ()'} -> `Int' #}
{# fun Fl_Tree_Item_move_into as move_into' { id `Ptr ()', id `Ptr ()', `Int'} -> `Int' #}
...
{# fun Fl_Tree_Item_prev as prev' { id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_next as next' { id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_next_sibling as nextSibling' { id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_prev_sibling as prevSibling' { id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_prev_displayed as prevDisplayed' { id `Ptr ()',id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_parent as parent' { id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_set_parent as setParent' { id `Ptr ()',id `Ptr ()' } -> `()' #}
...
{# fun Fl_Tree_Item_is_close as isClose' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_open_toggle as openToggle' { id `Ptr ()' } -> `()' #}
...
{# fun Fl_Tree_Item_deselect as deselect' { id `Ptr ()' } -> `()' #}
...
{# fun Fl_Tree_Item_is_selected as isSelected' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_activate as activate' { id `Ptr ()' } -> `()' #}
...
{# fun Fl_Tree_Item_activate_with_val as activateWithVal' { id `Ptr ()', cFromBool `Bool' } -> `()' #}
...
{# fun Fl_Tree_Item_is_active as isActive' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_visible as visible' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_is_visible as isVisible' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_visible_r as visibleR' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_set_usericon as setUsericon' { id `Ptr ()',id `Ptr ()' } -> `()' #}
...
{# fun Fl_Tree_Item_usericon as usericon' { id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_find_clicked as findClicked' { id `Ptr ()',id `Ptr ()' } -> `Ptr ()' id #}
...
{# fun Fl_Tree_Item_is_root as isRoot' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun Fl_Tree_Item_label_w as labelW' { id `Ptr ()' } -> `Int' #}
