...
import Graphics.UI.FLTK.LowLevel.Hierarchy hiding (IndexRange)
...
--
-- copy:: ('Parent' a 'TextBuffer') => 'Ref' 'TextBuffer' -> 'Ref' a -> 'Range' -> 'AtIndex' -> 'IO' ()
--
-- countDisplayedCharacters :: 'Ref' 'TextBuffer' -> 'Range' -> 'IO' ('Int')
--
-- countLines :: 'Ref' 'TextBuffer' -> 'Range' -> 'IO' ('Lines')
--
...
--
-- highlightPosition :: 'Ref' 'TextBuffer' -> 'IO' ('Maybe' 'Range')
--
...
--
-- outputfile :: 'Ref' 'TextBuffer' -> 'T.Text' -> 'Range' -> 'IO' ('Either' 'DataProcessingError' ())
--
-- outputfileWithBuflen :: 'Ref' 'TextBuffer' -> 'T.Text' -> 'Range' -> 'Int' -> 'IO' ('Either' 'DataProcessingError' ())
--
...
--
-- remove :: 'Ref' 'TextBuffer' -> 'Range' -> 'IO' ()
--
...
--
-- replace :: 'Ref' 'TextBuffer' -> 'Range' -> 'T.Text' -> 'IO' ()
--
...
--
-- textRange :: 'Ref' 'TextBuffer' -> 'Range' -> 'IO' 'T.Text'
--
