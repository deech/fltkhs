...
type MenuBar a            = MenuPrim (CMenuBar a)
...
type OverlayWindow a      = Window (COverlayWindow a)
data CPack a              = CPack
...
type SysMenuBar a         = Group (CSysMenuBar a)
...
type ValueInput a         = Input (CValueInput a)
data CValueOutput a       = CValueOutput
type ValueOutput a        = Output (CValueOutput a)
