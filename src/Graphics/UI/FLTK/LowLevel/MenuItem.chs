...
{# fun unsafe Fl_Menu_Item_submenu as submenu' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun unsafe Fl_Menu_Item_checkbox as checkbox' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun unsafe Fl_Menu_Item_radio as radio' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun unsafe Fl_Menu_Item_visible as visible' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun unsafe Fl_Menu_Item_active as active' { id `Ptr ()' } -> `Bool' cToBool #}
...
{# fun unsafe Fl_Menu_Item_activevisible as activevisible' { id `Ptr ()' } -> `Bool' cToBool #}
...
instance (impl ~  IO (MenuItemFlags)) => Op (GetFlags ()) MenuItem orig impl where
...
--
-- findShortcut:: ('Parent' a 'MenuItem') => 'Ref' 'MenuItem' -> 'Maybe' 'Int' -> 'Bool' -> 'IO' ('Ref' a))
--
-- getFirst :: 'Ref' 'MenuItem' -> 'IO' ('Maybe' ('Ref' 'MenuItem'))
--
-- getFlags :: 'Ref' 'MenuItem' -> 'IO' 'MenuItemFlags'
--
...
--
-- getShortcut :: 'Ref' 'MenuItem' -> 'IO' 'Int'
--
...
--
-- nextWithStep:: ('Parent' a 'MenuItem') => 'Ref' 'MenuItem' -> 'Int' -> 'IO' ('Ref' a))
--
-- popup:: ('Parent' a 'MenuItem', 'Parent' b 'MenuPrim', 'Parent' c 'MenuItem') => 'Ref' 'MenuItem' -> 'Position' -> 'Maybe' 'String' -> 'Maybe' ('Ref' a) -> 'Maybe' ('Ref' b) -> 'IO' ('Ref' c))
--
-- pulldown:: ('Parent' a 'MenuPrim', 'Parent' b 'MenuItem', 'Parent' c 'MenuItem') => 'Ref' 'MenuItem' -> 'Rectangle' -> 'Maybe' ('Ref' a) -> 'Maybe' ('Ref' b) -> 'Maybe' ('Ref' c) -> 'Maybe' 'Bool' -> 'IO' ('Ref' 'MenuItem'))
--
...
--
-- setShortcut :: 'Ref' 'MenuItem' -> 'Int' -> 'IO' ()
--
...
--
-- testShortcut:: ('Parent' a 'MenuItem') => 'Ref' 'MenuItem' -> 'IO' ('Ref' a))
--
