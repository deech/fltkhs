...
--
-- countLines :: 'Ref' 'TextDisplay' -> 'Range' -> 'Bool' -> 'IO' ('Int')
--
...
--
-- positionStyle :: 'Ref' 'TextDisplay' -> 'AtIndex' -> 'Int' -> 'Int' -> 'IO' 'TextDisplayStyle'
--
-- positionToXy :: 'Ref' 'TextDisplay' -> 'AtIndex' -> 'IO' ('Either' 'OutOfRange' 'Position')
--
-- previousWord :: 'Ref' 'TextDisplay' -> 'IO' ()
--
-- redisplayRange :: 'Ref' 'TextDisplay' -> 'Range' -> 'IO' ()
--
...
--
-- scroll :: 'Ref' 'TextDisplay' -> 'Int' -> 'AtIndex' -> 'IO' ()
--
