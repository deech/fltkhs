...
instance (Parent a Widget) => Op (Find ()) Group (Ref a->  IO (Int)) where
...
instance (Parent a Widget) => Op (Add ()) Group (Ref a->  IO (())) where
...
instance (Parent a Widget) => Op (Insert ()) Group (Ref a-> Int ->  IO (())) where
...
instance (Parent a Widget) => Op (RemoveWidget ()) Group (Ref a->  IO (())) where
...
instance (Parent a Widget) => Op (SetResizable ()) Group (Ref a ->  IO (())) where
...
instance (Parent a Widget) => Op (AddResizable ()) Group (Ref a ->  IO (())) where
...
instance (Parent a Widget) => Op (Focus ()) Group (Ref a ->  IO (())) where
...
instance (Parent a Widget, Parent b Widget) => Op (InsertWithBefore ()) Group (Ref a -> Ref b ->  IO (())) where
