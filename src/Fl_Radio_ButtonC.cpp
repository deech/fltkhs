...
EXPORT {
  ...
  FL_EXPORT_C(void,Fl_Radio_Button_set_background_and_selection_color)(fl_Radio_Button b,Fl_Color bg,Fl_Color a){
  ...
  FL_EXPORT_C(void,Fl_Radio_Button_set_visible_focus)(fl_Radio_Button b){
    (static_cast<Fl_Radio_Button*>(b))->visible_focus();
  }
  ...
  FL_EXPORT_C(void,Fl_Radio_Button_draw_label)(fl_Radio_Button b,int x,int y,int w,int h,Fl_Align alignment){
