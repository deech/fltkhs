...
EXPORT {
  ...
  FL_EXPORT_C(void,         Fl_Round_Button_set_background_and_selection_color)(fl_Round_Button round_button,Fl_Color bg, Fl_Color a);
  ...
  FL_EXPORT_C(void,         Fl_Round_Button_draw_label)(fl_Round_Button round_button, int x , int y , int w, int h, Fl_Align alignment);
