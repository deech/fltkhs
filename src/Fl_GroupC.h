...
EXPORT {
  ...
  FL_EXPORT_C(void,         Fl_Group_set_background_and_selection_color)(fl_Group group,Fl_Color bg, Fl_Color a);
  ...
  FL_EXPORT_C(void,         Fl_Group_draw_label)(fl_Group group, int x , int y , int w, int h, Fl_Align alignment);
