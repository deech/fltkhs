...
EXPORT {
#endif
  FL_EXPORT_C_HEADER(fl_Tree_Prefs,Fl_Tree_Prefs_New,());
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_Destroy,(fl_Tree_Prefs prefs));
  FL_EXPORT_C_HEADER(Fl_Font,Fl_Tree_Prefs_item_labelfont,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_item_labelfont,(fl_Tree_Prefs tree_prefs, Fl_Font val));
  FL_EXPORT_C_HEADER(Fl_Fontsize,Fl_Tree_Prefs_item_labelsize,(fl_Tree_Prefs tree_prefs));
  ...
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_labelsize,(fl_Tree_Prefs tree_prefs, Fl_Fontsize val));
  FL_EXPORT_C_HEADER(Fl_Color,Fl_Tree_Prefs_labelfgcolor,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_labelfgcolor,(fl_Tree_Prefs tree_prefs, Fl_Color val));
  FL_EXPORT_C_HEADER(Fl_Color,Fl_Tree_Prefs_labelbgcolor,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_labelbgcolor,(fl_Tree_Prefs tree_prefs, Fl_Color val));
  FL_EXPORT_C_HEADER(int,Fl_Tree_Prefs_marginleft,(fl_Tree_Prefs tree_prefs));
  ...
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_connectorcolor,(fl_Tree_Prefs tree_prefs, Fl_Color val));
  FL_EXPORT_C_HEADER(Fl_Tree_Connector,Fl_Tree_Prefs_connectorstyle,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_connectorstyle_with_tree_connector,(fl_Tree_Prefs tree_prefs, Fl_Tree_Connector val));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_connectorstyle_with_val,(fl_Tree_Prefs tree_prefs, int val));
  FL_EXPORT_C_HEADER(int,Fl_Tree_Prefs_connectorwidth,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_connectorwidth,(fl_Tree_Prefs tree_prefs, int val));
  FL_EXPORT_C_HEADER(fl_Image,Fl_Tree_Prefs_openicon,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_openicon,(fl_Tree_Prefs tree_prefs, fl_Image val));
  FL_EXPORT_C_HEADER(fl_Image,Fl_Tree_Prefs_closeicon,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_closeicon,(fl_Tree_Prefs tree_prefs, fl_Image val));
  FL_EXPORT_C_HEADER(fl_Image,Fl_Tree_Prefs_usericon,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_usericon,(fl_Tree_Prefs tree_prefs, fl_Image val));
  FL_EXPORT_C_HEADER(char,Fl_Tree_Prefs_showcollapse,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_showcollapse,(fl_Tree_Prefs tree_prefs, int val));
  FL_EXPORT_C_HEADER(Fl_Tree_Sort,Fl_Tree_Prefs_sortorder,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_sortorder,(fl_Tree_Prefs tree_prefs, Fl_Tree_Sort val));
  FL_EXPORT_C_HEADER(Fl_Boxtype,Fl_Tree_Prefs_selectbox,(fl_Tree_Prefs tree_prefs));
  FL_EXPORT_C_HEADER(void,Fl_Tree_Prefs_set_selectbox,(fl_Tree_Prefs tree_prefs, Fl_Boxtype val));
  FL_EXPORT_C_HEADER(int,Fl_Tree_Prefs_showroot,(fl_Tree_Prefs tree_prefs));
