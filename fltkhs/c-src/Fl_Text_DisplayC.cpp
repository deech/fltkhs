...
void Fl_DerivedText_Display::destroy_data(){
  if (this->overriddenFuncs->destroy_data != NULL){
    ...
    Function_Pointers_To_Free* res = C_to_Fl_Callback::gather_function_pointers(num_fps+2,num_fps,fps,(fl_DoNotCall)cb, (fl_DoNotCall)(this->mUnfinishedHighlightCB));
